...
writer = SummaryWriter('tensorboard/Transformer7')
loss_spann = []
...
model_save_path = 'models/Transformer7.pth'
torch.save(net.state_dict(), model_save_path)

# Salva i log delle loss
with open('losses/loss_spannTransformer7.txt', 'w') as file:
    for valore in loss_spann:
        file.write(str(valore) + '\n')

with open('losses/loss_spannTransformer7_val.txt', 'w') as file:
