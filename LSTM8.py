    ...
    for epoch in range(max_epoch):
        ...
        for inputs, labels in train_dataloader:
            ...
            if j == 1:
                ...
                print(f'label original : {specific_label_denorm[0]*1e4:.3f} 1e-4 {specific_label_denorm[1]*1e4:.3f} 1e-4 {specific_label_denorm[2]*1e4:.3f} 1e-4  
                      {specific_label_denorm[3]:.3f} {specific_label_denorm[4]:.3f} {specific_label_denorm[5]:.3f}')
                print(f'ouput nn       : {specific_output_denorm[0]*1e4:.3f} 1e-4 {specific_output_denorm[1]*1e4:.3f} 1e-4 {specific_output_denorm[2]*1e4:.3f} 1e-4  
                      {specific_output_denorm[3]:.3f} {specific_output_denorm[4]:.3f} {specific_output_denorm[5]:.3f}')
