...
net = GRUNet(hidden_size, output_size)
net.to(device)
...
model_save_path = 'GRU41.pth'
torch.save(net.state_dict(), model_save_path)

# Salva i log delle loss
with open('loss_spannGRU41.txt', 'w') as file:
    for valore in loss_spann:
        file.write(str(valore) + '\n')

with open('loss_spannGRU41_val.txt', 'w') as file:
...
# Carico modello
net=GRUNet(hidden_size=hidden_size, 
